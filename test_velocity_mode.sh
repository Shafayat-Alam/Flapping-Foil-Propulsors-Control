#!/bin/bash
# test_velocity_mode.sh - Mission Sequence Test (velocity mode)
# Usage: ./test_velocity_mode.sh
# Prerequisite: launch the stack with operating_mode: 'velocity'.
...
echo "========================================="
echo "Starting Mission Test Sequence (velocity mode)"
echo "========================================="
echo ""
...
echo ""
echo "========================================="
echo "Mission Test Sequence Complete (velocity mode)"
echo "========================================="
